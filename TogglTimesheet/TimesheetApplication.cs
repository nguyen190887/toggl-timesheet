...
namespace TogglTimesheet
{
    ...
    public class TimesheetApplication
    {
        ...
        public TimesheetApplication(IConfiguration configuration, IHttpClientFactory? httpClientFactory = null)
        {
            ...
            string outputFile)
        {
            ...
            var baseAddress = _configuration.GetSection("TogglApi:BaseAddress").Value ?? "https://localhost";
            using var httpClient = _httpClientFactory.CreateClient(baseAddress);
            ...
            string configKey)
        {
            return parameters.GetValueOrDefault(paramName) ??
                   ...
                   _configuration.GetSection(configKey).Value ?? string.Empty;
        }
        ...
        {
            var configuredPath = _configuration.GetSection("TogglApi:TaskRuleFile").Value;
